            ...
            for cls in self.classes:
                ...
                while s < len(tokens):
                    ...
                    for txt_inp in txt_inps:
                        ...
                        feat_ = torch.mean(torch.cat(feat_, dim=1), dim=1)
                        feat.append(feat_)
                    feat = torch.cat(feat) 
